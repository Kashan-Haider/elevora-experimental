  ...
  return (
    <div className="min-h-screen bg-primary text-primaryText flex items-center justify-center px-4">
      <div className="max-w-xl w-full bg-surface p-8 rounded-2xl shadow-xl border border-border">
        <h1 className="text-3xl font-semibold mb-2 text-primaryAccent">Create a New Project</h1>
        <p className="text-secondaryText mb-6">Enter project details to begin managing your SEO efficiently.</p>
